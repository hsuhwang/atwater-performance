...
class PopulateOrders extends Simulation {
    ...
    val insertProductTable: ChainBuilder =
      exec(
        cql("InsertOrder")
          ...
          .withParams(List("order_id", "customer_id", "product_id", "order_status", "customer_address", "customer_name", "color", "product_description", "product_name", "price", "quantity", "size", "upc"))
      )
